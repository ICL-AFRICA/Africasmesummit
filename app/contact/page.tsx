...
export const metadata: Metadata = {
  ...
  description: "Contact the Africa SME Summit team about tickets, group bookings, speaking, partnership or exhibiting. 30 September 2026, University of Nairobi.",
